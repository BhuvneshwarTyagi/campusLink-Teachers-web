                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        AutoSizeText(
                                                                          "Assignment:${widget.selectedindex}(${(int.parse(snapshot.data!["Assignment-${index + 1}"]["Size"].toString()) / 1048576).toStringAsFixed(2)}MB)",
                                                                          style: GoogleFonts.courgette(
                                                                              color: Colors.black,
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child: ElevatedButton(
                                                                          ...
                                                                          child: AutoSizeText(
                                                                            "Reject",
                                                                            style:
                                                                                GoogleFonts.gfsDidot(fontWeight: FontWeight.w500, fontSize: size.height * 0.04),
                                                                          )),
                                                                    ),
                                                                    Container(
                                                                      height: size
                                                                      ...
                                                                      child: ElevatedButton(
                                                                          ...
                                                                          child: AutoSizeText(
                                                                            "Accept",
                                                                            style:
                                                                                GoogleFonts.gfsDidot(fontWeight: FontWeight.w600, fontSize: size.height * 0.05),
                                                                          )),
                                                                    ),
                                                                  ],
                                                                ))
